...
// The original flashinfer headers cause conflicts with the Windows
// toolchain.  Only the lightweight vector helpers are required here.
// Other flashinfer utilities are omitted for compatibility.
